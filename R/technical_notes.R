technical_notes <- function() {
  tabPanel(
    ...
    p("Each area's performance is compared with the same period of the previous year. A green arrow denotes those areas whose performance has improved (NEET gone down/participation gone up),
      a red arrow where performance is lower (NEET gone up/participation gone down) and a white horizontal line where performance has stayed the same compared to the previous year. A cross denotes that comparison to the previous
