...
fig <- fig %>% add_trace(
  ...
  mode = "gauge+number",
  gauge = list(
    axis = list(range = range, tickwidth = 1, tickcolor = "darkblue",
                tickvals=intervals,
...
fig <- fig %>% add_trace(
  ...
  mode = "gauge",
  gauge = list(
    axis = list(range = range, tickwidth = 2, 
                tickcolor = "black",
...
fig <- fig %>% add_trace(
  ...
  mode = "gauge",
  gauge = list(
    axis = list(range = range, tickwidth = 4, tickcolor = "black",
...
fig <- fig %>% add_trace(
  ...
  mode = "gauge",
  gauge = list(
    axis = list(range = range, tickwidth = 2, tickcolor = "#2073BC",
