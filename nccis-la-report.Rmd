...
```{r gauge_chart_neetnk, echo=FALSE, out.width="175%"}
...
```{r gauge_chart_neet, echo=FALSE, out.width="175%"}
...
```{r part_guage, echo=FALSE, out.width="175%"}
...
```{r gauge_chart_Sept_Guar, echo=FALSE, out.width="175%"}
